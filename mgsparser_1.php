        ...
        public function collectData(){
            ...
            foreach($routes as $route){
                ...
                foreach($days as $day){
                    ...
                    $this->_dropBus($route, $real_directions);
        ...
        private function _dropTimetable($route, $direction, $day, &$timetable){
            ...
            foreach($timetable as $station => $races){
                foreach($races as $race_index => $race_time){
        			...
        			$PROP[5] = $_schedules[$day];//График движения - будни/выходные и т.п тоже из справочника...
        			...
        			$arLoadProductArray = Array(
        				...
        				/*if(false !== $PRODUCT_ID = $el->Add($arLoadProductArray)){
        				//echo "<br/>New Time: ".$time; 
        				//echo '<pre>'; print_r($arLoadProductArray); die();
        				}			
        				else{	
...
*/						
        ...
        private function _dropBus($route_number, $directions){
            $PROP = array();
            $PROP[11] = $this->_town_id;//Город
            $PROP[12] = 36; //Тип
            $PROP[13] = $directions['AB'];//Название направления - прямое
            $PROP[19] = ((isset($directions['BA'])) ? $directions['BA'] : '');//Название направления - обратное
            ...
            //$PROP[15] = $src;//Ссылка на страницу - не обязательно	
  ...
  /*          if(false !== $PRODUCT_ID = $this->_CBIE->Add($arLoadProductArray)){ 
        ...
        private function _transletiration($station){
            $trans = array('а'=>'a','б'=>'b','в'=>'v','г'=>'g','д'=>'d','е'=>'e', 'ё'=>'yo','ж'=>'j','з'=>'z','и'=>'i','й'=>'i','к'=>'k','л'=>'l', 'м'=>'m','н'=>'n','о'=>'o','п'=>'p','р'=>'r','с'=>'s','т'=>'t', 'у'=>'y','ф'=>'f','х'=>'h','ц'=>'c','ч'=>'ch', 'ш'=>'sh','щ'=>'sh','ы'=>'i','э'=>'e','ю'=>'u','я'=>'ya',
              ...
              $trans_station=strtolower(strtr($station, $trans));
