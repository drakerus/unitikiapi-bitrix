...
b.data&&!m(a.data,b.data)||a&&a.type&&a.type.toLowerCase()!=b.type.toLowerCase()?null:a}function t(a,b,e){var c=function(c){return function(){return function(){var c;this.status=a.status;this.statusText=a.statusText;this.readyState=4;d.isFunction(a.response)&&a.response(e);"json"==b.dataType&&"object"==typeof a.responseText?this.responseText=JSON.stringify(a.responseText):"xml"==b.dataType?"string"==typeof a.responseXML?(this.responseXML=q(a.responseXML),this.responseText=a.responseXML):this.responseXML=
...
b.responseXML;a.responseText=b.responseText;a.status===d.mockjaxSettings.status&&(a.status=b.status);a.statusText===d.mockjaxSettings.statusText&&(a.statusText=b.statusText);this.responseTimer=setTimeout(c,a.responseTime||0)}}):!1===b.async?c():this.responseTimer=setTimeout(c,a.responseTime||50)}function u(a,b,e,c){a=d.extend(!0,{},d.mockjaxSettings,a);"undefined"===typeof a.headers&&(a.headers={});a.contentType&&(a.headers["content-type"]=a.contentType);return{status:a.status,statusText:a.statusText,
readyState:1,open:function(){},send:function(){c.fired=!0;t.call(this,a,b,e)},abort:function(){clearTimeout(this.responseTimer)},setRequestHeader:function(b,c){a.headers[b]=c},getResponseHeader:function(b){if(a.headers&&a.headers[b])return a.headers[b];if("last-modified"==b.toLowerCase())return a.lastModified||(new Date).toString();if("etag"==b.toLowerCase())return a.etag||"";if("content-type"==b.toLowerCase())return a.contentType||"text/plain"},getAllResponseHeaders:function(){var b="";d.each(a.headers,
function(a,c){b+=a+": "+c+"\n"});return b}}}function v(a,b,e){"GET"===a.type.toUpperCase()?g.test(a.url)||(a.url+=(/\?/.test(a.url)?"&":"?")+(a.jsonp||"callback")+"=?"):a.data&&g.test(a.data)||(a.data=(a.data?a.data+"&":"")+(a.jsonp||"callback")+"=?");a.dataType="json";if(a.data&&g.test(a.data)||g.test(a.url)){w(a,b,e);var c=/^(\w+:)?\/\/([^\/?#]+)/.exec(a.url),c=c&&(c[1]&&c[1]!==location.protocol||c[2]!==location.host);a.dataType="script";if("GET"===a.type.toUpperCase()&&c){var c=e&&e.context||a,
f=null;b.response&&d.isFunction(b.response)?b.response(e):"object"===typeof b.responseText?d.globalEval("("+JSON.stringify(b.responseText)+")"):d.globalEval("("+b.responseText+")");n(a,c,b);p(a,c,b);d.Deferred&&(f=new d.Deferred,"object"==typeof b.responseText?f.resolveWith(c,[b.responseText]):f.resolveWith(c,[d.parseJSON(b.responseText)]));return(a=f)?a:!0}}return null}function w(a,b,d){var c=d&&d.context||a,f=a.jsonpCallback||"jsonp"+x++;a.data&&(a.data=(a.data+"").replace(g,"="+f+"$1"));a.url=
...
d.event.trigger("ajaxStop")}function y(a,b){if(a.url instanceof RegExp&&a.hasOwnProperty("urlParams")){var d=a.url.exec(b.url);if(1!==d.length){d.shift();var c=0,f=Math.min(d.length,a.urlParams.length),h={};for(c;c<f;c++)h[a.urlParams[c]]=d[c];b.urlParams=h}}}var k=d.ajax,h=[],l=[],g=/=\?(&|$)/,x=(new Date).getTime();d.extend({ajax:function(a,b){var e,c,f;"object"===typeof a?(b=a,a=void 0):b.url=a;c=d.extend(!0,{},d.ajaxSettings,b);for(var g=0;g<h.length;g++)if(h[g]&&(f=r(h[g],c))){l.push(c);d.mockjaxSettings.log(f,
c);if("jsonp"===c.dataType&&(e=v(c,f,b)))return e;f.cache=c.cache;f.timeout=c.timeout;f.global=c.global;y(f,b);(function(a,b,c,f){e=k.call(d,d.extend(!0,{},c,{xhr:function(){return u(a,b,c,f)}}))})(f,c,b,h[g]);return e}if(!0===d.mockjaxSettings.throwUnmocked)throw"AJAX not mocked: "+b.url;return k.apply(d,[b])}});d.mockjaxSettings={log:function(a,b){if(!1!==a.logging&&("undefined"!==typeof a.logging||!1!==d.mockjaxSettings.logging)&&window.console&&console.log){var e="MOCK "+b.type.toUpperCase()+
