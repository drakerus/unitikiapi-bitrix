...
$all_stations_id_array[]=$row['id_station'];
}
...
$next=$num+1;
$station_id=$all_stations_id_array[$num];
$prop_array=$all_stations_array[$station_id];
/*
echo '<pre>';
 print_r('')
*/
...
?>
<?/*
$_SESSION["parse"]["step_6"]="OK";
$_SESSION["parse"]["current_step"]="step_6";
...
<?
if($num>0){usleep(250);}
$mnum=count($all_stations_id_array)-1;
if($num>=$mnum){	
$_SESSION["parse"]["step_6"]="OK";
$_SESSION["parse"]["current_step"]="step_6";
$_SESSION["parse"]["id_town"]=TOWN_ID;
